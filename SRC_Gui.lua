if (game:GetService("CoreGui")):FindFirstChild("Sentai") and (game:GetService("CoreGui")):FindFirstChild("ScreenGui") then

	(game:GetService("CoreGui")).Sentai:Destroy();
...
local OutlineButton_corner = Instance.new("UICorner")
OutlineButton_corner.CornerRadius = UDim.new(0, 8)
OutlineButton_corner.Parent = OutlineButton
;
...
ImageButton.Image = "rbxassetid://129500678263595";
...
ImageButton.MouseButton1Click:connect(function()
	...
	(game.CoreGui:FindFirstChild("Sentai")).Enabled = not (game.CoreGui:FindFirstChild("Sentai")).Enabled;
...
local OutlineFrame_corner = Instance.new("UICorner")
OutlineFrame_corner.CornerRadius = UDim.new(0, 8)
OutlineFrame_corner.Parent = OutlineFrame
;
	...
	OutlineFrame.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	Image.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	Image.Image = "rbxassetid://83909638229038";
...
local LoaderFrame_corner = Instance.new("UICorner")
LoaderFrame_corner.CornerRadius = UDim.new(0, 8)
LoaderFrame_corner.Parent = LoaderFrame
;
	...
	LoaderFrame.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	LoaderFrame.BackgroundTransparency = 0.3;
...
local MainLoaderFrame_corner = Instance.new("UICorner")
MainLoaderFrame_corner.CornerRadius = UDim.new(0, 8)
MainLoaderFrame_corner.Parent = MainLoaderFrame
;
	...
	MainLoaderFrame.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	MainLoaderFrame.BackgroundTransparency = 0.3;
	...
	TitleLoader.BackgroundTransparency = 0.3;
	...
	DescriptionLoader.BackgroundTransparency = 0.3;
...
local LoadingBarBackground_corner = Instance.new("UICorner")
LoadingBarBackground_corner.CornerRadius = UDim.new(0, 8)
LoadingBarBackground_corner.Parent = LoadingBarBackground
;

	LoadingBarBackground.Parent = MainLoaderFrame;

	LoadingBarBackground.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local LoadingBar_corner = Instance.new("UICorner")
LoadingBar_corner.CornerRadius = UDim.new(0, 8)
LoadingBar_corner.Parent = LoadingBar
;

	LoadingBar.Parent = LoadingBarBackground;

	LoadingBar.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
(getgenv()).LoadConfig = function()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfolder("Sentai") then

			makefolder("Sentai");

		end;

		if not isfolder("Sentai/Library/") then

			makefolder("Sentai/Library/");

		end;

		if not isfile(("Sentai/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then

			writefile("Sentai/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(SettingsLib));

		else

			local Decode = (game:GetService("HttpService")):JSONDecode(readfile("Sentai/Library/" .. game.Players.LocalPlayer.Name .. ".json"));
...
(getgenv()).SaveConfig = function()
	...
	if readfile and writefile and isfile and isfolder then
		...
		if not isfile(("Sentai/Library/" .. game.Players.LocalPlayer.Name .. ".json")) then
			...
			writefile("Sentai/Library/" .. game.Players.LocalPlayer.Name .. ".json", (game:GetService("HttpService")):JSONEncode(Array));
...
function Update:Window(Config)
	...
	local Sentai = Instance.new("ScreenGui");

	Sentai.Name = "Sentai";

	Sentai.Parent = game.CoreGui;

	Sentai.DisplayOrder = 999;

	local OutlineMain = Instance.new("Frame")
local OutlineMain_corner = Instance.new("UICorner")
OutlineMain_corner.CornerRadius = UDim.new(0, 8)
OutlineMain_corner.Parent = OutlineMain
;

	OutlineMain.Name = "OutlineMain";

	OutlineMain.Parent = Sentai;

	OutlineMain.ClipsDescendants = true;

	OutlineMain.AnchorPoint = Vector2.new(0.5, 0.5);

	OutlineMain.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
;
	...
	Main.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local DragButton_corner = Instance.new("UICorner")
DragButton_corner.CornerRadius = UDim.new(0, 8)
DragButton_corner.Parent = DragButton
;
...
;
	...
	Top.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	NameHub.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	NameHub.BackgroundTransparency = 0.3;
	...
	SubTitle.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	SubTitle.BackgroundTransparency = 0.3;
...
local BackgroundSettings_corner = Instance.new("UICorner")
BackgroundSettings_corner.CornerRadius = UDim.new(0, 8)
BackgroundSettings_corner.Parent = BackgroundSettings
;
	...
	BackgroundSettings.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local SettingsFrame_corner = Instance.new("UICorner")
SettingsFrame_corner.CornerRadius = UDim.new(0, 8)
SettingsFrame_corner.Parent = SettingsFrame
;
	...
	SettingsFrame.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	CloseSettings.BackgroundTransparency = 0.3;
	...
	TitleSettings.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	TitleSettings.BackgroundTransparency = 0.3;
...
local SettingsMenuList_corner = Instance.new("UICorner")
SettingsMenuList_corner.CornerRadius = UDim.new(0, 8)
SettingsMenuList_corner.Parent = SettingsMenuList
;
	...
	SettingsMenuList.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	ScrollSettings.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

	ScrollSettings.Position = UDim2.new(0, 0, 0, 0);

	ScrollSettings.BackgroundTransparency = 0.3;
...
;
		...
		Background.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
		...
		Checkbox.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
Tab_corner.CornerRadius = UDim.new(0, 8)
...
;
	...
	Tab.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
	...
	ScrollTab.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local Page_corner = Instance.new("UICorner")
Page_corner.CornerRadius = UDim.new(0, 8)
Page_corner.Parent = Page
;
...
local MainPage_corner = Instance.new("UICorner")
MainPage_corner.CornerRadius = UDim.new(0, 8)
MainPage_corner.Parent = MainPage
;
	...
	MainPage.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local SelectedTab_corner = Instance.new("UICorner")
SelectedTab_corner.CornerRadius = UDim.new(0, 8)
SelectedTab_corner.Parent = SelectedTab
;
		...
		SelectedTab.BackgroundTransparency = 0.3;
		...
		IDK.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local Black_corner = Instance.new("UICorner")
Black_corner.CornerRadius = UDim.new(0, 8)
Black_corner.Parent = Black
;
			...
			TextButton.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			ArrowRight.BackgroundTransparency = 0.3;
			...
			Black.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
Circle_corner.CornerRadius = UDim.new(0, 8)
Circle_corner.Parent = Circle
;

			local ToggleFrame = Instance.new("Frame")
local ToggleFrame_corner = Instance.new("UICorner")
ToggleFrame_corner.CornerRadius = UDim.new(0, 8)
ToggleFrame_corner.Parent = ToggleFrame
;
			...
			Title2.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			Desc.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			ToggleImage.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

			ToggleImage.BackgroundTransparency = 0.3;
			...
			Circle.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local DropdownFrameScroll_corner = Instance.new("UICorner")
DropdownFrameScroll_corner.CornerRadius = UDim.new(0, 8)
DropdownFrameScroll_corner.Parent = DropdownFrameScroll
;
			...
			SelectItems.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			ArrowDown.BackgroundTransparency = 0.3;
			...
			DropdownFrameScroll.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

			DropdownFrameScroll.BackgroundTransparency = 0.3;
			...
			DropScroll.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

			DropScroll.BackgroundTransparency = 0.3;
...
local SelectedItems_corner = Instance.new("UICorner")
SelectedItems_corner.CornerRadius = UDim.new(0, 8)
SelectedItems_corner.Parent = SelectedItems
;
				...
				SelectedItems.BackgroundTransparency = 0.3;
...
local sliderr_corner = Instance.new("UICorner")
sliderr_corner.CornerRadius = UDim.new(0, 8)
sliderr_corner.Parent = sliderr
;
...
local HAHA_corner = Instance.new("UICorner")
HAHA_corner.CornerRadius = UDim.new(0, 8)
HAHA_corner.Parent = HAHA
;
...
bar_corner.CornerRadius = UDim.new(0, 8)
bar_corner.Parent = bar
;

			local bar1 = Instance.new("Frame")
local bar1_corner = Instance.new("UICorner")
bar1_corner.CornerRadius = UDim.new(0, 8)
bar1_corner.Parent = bar1
;
...
local circlebar_corner = Instance.new("UICorner")
circlebar_corner.CornerRadius = UDim.new(0, 8)
circlebar_corner.Parent = circlebar
;

			local UICorner = Instance.new("UICorner");

			local slidervalue = Instance.new("Frame")
local slidervalue_corner = Instance.new("UICorner")
slidervalue_corner.CornerRadius = UDim.new(0, 8)
slidervalue_corner.Parent = slidervalue
;
			...
			sliderr.BackgroundTransparency = 0.3;
			...
			ValueText.BackgroundColor3 = Color3.fromRGB(200, 200, 255);

			ValueText.BackgroundTransparency = 0.3;
			...
			bar.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			bar1.BackgroundTransparency = 0.3;
			...
			circlebar.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
;
			...
			TextboxLabel.BackgroundTransparency = 0.3;
			...
			RealTextbox.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
;
			...
			Label.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
			...
			ImageLabel.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local Seperator_corner = Instance.new("UICorner")
Seperator_corner.CornerRadius = UDim.new(0, 8)
Seperator_corner.Parent = Seperator
;
...
Seperator.BackgroundTransparency = 0.3;
...
Sep1.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
Sep2.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
Sep3.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
local Linee_corner = Instance.new("UICorner")
Linee_corner.CornerRadius = UDim.new(0, 8)
Linee_corner.Parent = Linee
;

			local Line = Instance.new("Frame")
local Line_corner = Instance.new("UICorner")
Line_corner.CornerRadius = UDim.new(0, 8)
...
;
			...
			Linee.BackgroundColor3 = Color3.fromRGB(200, 200, 255);
...
-- Apply to all Frames in the GUI
